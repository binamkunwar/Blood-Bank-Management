...
public class UpdateDetails extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("UPDATE DONAR DETAIL");

        Savebtn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Savebtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/updated.png"))); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(CText, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
                                    .addComponent(EText, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
                                    .addComponent(BText)))
    ...
    String id=idText.getText();
        ...
        String province=(String)CText.getSelectedText();
...
stmt.executeUpdate("UPDATE  bloodbankmanagement.adddonar set FullName='"+fullName+"',FatherName='"+fatherName+"',MotherName='"+motherName+"',Age='"+age+"',Mobile='"+number+"',Gender='"+Gender+"',Email='"+email+"',BloodGroup='"+bloodgrp+"',Province='"+province+"',Address='"+coAddr+"'where id='"+id+"'" );
