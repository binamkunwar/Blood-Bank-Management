...
public class HomePagenew extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Donattion = new javax.swing.JButton();
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/Donate.png"))); // NOI18N
        ...
        AllDonar.setIconTextGap(6);
        AllDonar.setMaximumSize(new java.awt.Dimension(10, 10));
        AllDonar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AllDonarActionPerformed(evt);
            }
        });
        getContentPane().add(AllDonar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 210, 50));
        ...
        stock.setIconTextGap(6);
        stock.setMaximumSize(new java.awt.Dimension(10, 10));
        stock.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                stockActionPerformed(evt);
            }
        });
        getContentPane().add(stock, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 600, 200, 50));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 210, 50));
        ...
        Delete.setMaximumSize(new java.awt.Dimension(10, 10));
        Delete.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DeleteActionPerformed(evt);
            }
        });
        getContentPane().add(Delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 520, 200, 50));
        ...
        Update.setMaximumSize(new java.awt.Dimension(10, 10));
        Update.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UpdateActionPerformed(evt);
            }
        });
        getContentPane().add(Update, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 440, 200, 50));
        ...
        addDonar.setIconTextGap(6);
        addDonar.setMaximumSize(new java.awt.Dimension(10, 10));
        addDonar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addDonarActionPerformed(evt);
            }
        });
        getContentPane().add(addDonar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, 200, 50));
        ...
        getContentPane().add(LOGOUT, new org.netbeans.lib.awtextra.AbsoluteConstraints(1350, 160, 140, 50));

        Search.setBackground(new java.awt.Color(255, 153, 153));
        Search.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        Search.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/placeholder.png"))); // NOI18N
        Search.setText("SEARCH ");
        Search.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        Search.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Search.setIconTextGap(6);
        Search.setMaximumSize(new java.awt.Dimension(10, 10));
        Search.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SearchActionPerformed(evt);
            }
        });
        getContentPane().add(Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 670, 200, 50));

        Donattion.setBackground(new java.awt.Color(255, 153, 153));
        Donattion.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        Donattion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/Donate.png"))); // NOI18N
        Donattion.setText("DONATION");
        Donattion.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        Donattion.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Donattion.setIconTextGap(6);
        Donattion.setMaximumSize(new java.awt.Dimension(10, 10));
        Donattion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DonattionActionPerformed(evt);
            }
        });
        getContentPane().add(Donattion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 740, 200, 50));

        NavBar.setBackground(new java.awt.Color(204, 0, 51));
        NavBar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/bg.jpg"))); // NOI18N
        NavBar.setText("jLabel1");
        getContentPane().add(NavBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 300, 930));

        BACKGROUND.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/Background.png"))); // NOI18N
        getContentPane().add(BACKGROUND, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -40, 2100, 1170));

        OutPutPanel.setMaximumSize(new java.awt.Dimension(743, 608));
        OutPutPanel.setMinimumSize(new java.awt.Dimension(743, 608));
        OutPutPanel.setPreferredSize(new java.awt.Dimension(812, 608));
        getContentPane().add(OutPutPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(328, 190, 1010, 620));
...
//            OutPutPanel.add(new Donation());
 ...
 new Request().setVisible(true);
    ...
    private void DonattionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DonattionActionPerformed
        // TODO add your handling code here:
        new DonationDate().setVisible(true);
    }//GEN-LAST:event_DonattionActionPerformed
    ...
    private javax.swing.JButton Donattion;
