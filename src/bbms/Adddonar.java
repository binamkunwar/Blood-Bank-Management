...
public class Adddonar extends javax.swing.JFrame {
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        String id=idText.getText().toLowerCase();
        
        String fullName=FText.getText().toLowerCase();
       
        String fatherName=FaText.getText().toLowerCase();
        String motherName=MoText.getText().toLowerCase();
        ...
        String coAddr=CoText.getText().toLowerCase();
       
        try{
            Connection con=dbConnection.getCon();
             Statement stmt=con.createStatement();
            
         stmt.executeUpdate("insert into bloodbankmanagement.adddonar(id,FullName,FatherName,MotherName,Age,Mobile,Gender,Email,BloodGroup,Province,Address) "
           + "values('"+id+"','"+fullName+"','"+fatherName+"','"+motherName+"','"+age+"','"+number+"','"+Gender+"','"+email+"','"+bloodgrp+"','"+province+"','"+coAddr+"')");
                 JOptionPane.showMessageDialog(null, "Donar added sucessfully");
                 setVisible(false);
